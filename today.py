...
USER_NAME = os.environ['USER_NAME'] # 'BojidarDermendjiev'
...
if __name__ == '__main__':
    """
    Bojidar Dermendjiev (BojidarDermendjiev)
    Based on Andrew6rant's profile stats generator (https://github.com/Andrew6rant/Andrew6rant)
    """
    ...
    # TODO: set your own birth date below (year, month, day) — used for the "Uptime" line
